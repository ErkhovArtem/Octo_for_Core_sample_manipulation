...
class UR3Teleop:
    ...
    def getInverseKinematicsHasSolution(self, pose):
        """
        Check if inverse kinematics has a solution.

        Args:
            pose: A list of 6 values (x, y, z, rx, ry, rz)
        
        Returns:
            Bool: true if getInverseKin has a solution, false otherwise.
        """
    
        return self.rtde_c.getInverseKinematicsHasSolution(pose)
